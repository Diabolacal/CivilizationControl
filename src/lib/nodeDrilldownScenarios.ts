...
export const NODE_DRILLDOWN_SCENARIOS: NodeLocalScenario[] = [
  createScenario({
    ...
    structures: [
      ...
      ...repeatStructures("tradePost", 1, { labelPrefix: "Trade Post", typeLabel: "Storage" }),
  ...
  createScenario({
    ...
    structures: [
      ...
      ...repeatStructures("tradePost", 2, { labelPrefix: "Trade Post", typeLabel: "Storage" }),
  ...
  createScenario({
    ...
    structures: [
      ...
      ...repeatStructures("tradePost", 3, { labelPrefix: "Trade Post", typeLabel: "Storage" }),
