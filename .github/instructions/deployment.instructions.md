...
- Never trust stale local `.env` defaults when sponsor or shared-backend URLs matter. Use explicit public `VITE_*` overrides for preview and production deploy builds.
